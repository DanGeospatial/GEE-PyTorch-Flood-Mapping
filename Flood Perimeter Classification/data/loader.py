...
mask_path = "/mnt/d/SAR_testing/masks/"
...
tran = ab.Compose([ab.HorizontalFlip(p=0.5), ab.VerticalFlip(p=0.5), ab.GaussNoise(p=0.3),
               ab.GridDistortion(p=0.2), ab.RandomBrightnessContrast((0,0.5),(0,0.5), p=0.4)])
